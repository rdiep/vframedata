...
public class DoubleLariat {
    ...
    @SerializedName("multiActive")
    private List<Long> mMultiActive;
    ...
    public List<Long> getMultiActive() {
        return mMultiActive;
    }

    public void setMultiActive(List<Long> multiActive) {
        mMultiActive = multiActive;
    }
